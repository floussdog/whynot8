  ...
  if choicest == "1":
          ...
          try:
              with open('smssenderdb.pickle', 'wb') as wfp:
               pickle.dump((input_number, input_token), wfp, protocol=pickle.HIGHEST_PROTOCOL)
              print("\033[H\033[J")
...
KIMBOSS KIMBOSS
 \033[1;0m                         
  ...
  try:
    ...
    print("\033[1;33mSettings SID:" + from_n + " token:" + token + "\033[1;0m")
...
KIMBOSS KIMBOSS
  ...
  try:
    ...
    print("\033[1;33mSettings SID:" + from1 + " token:" + token + "\033[1;0m")
